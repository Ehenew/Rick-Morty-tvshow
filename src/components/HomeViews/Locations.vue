      ...
      <div v-else
        ...
        <div v-for="location in locations"
          ...
          <router-link
            ...
            <div
              class="bg-[#102141f1] border-[1px] border-green-600 rounded-full px-16 py-3 w-96 hover:bg-[#0E1C36] hover:border-orange-400 cursor-pointer text-center text-orange-300">
              {{ location.name }}
            </div>
          </router-link>
