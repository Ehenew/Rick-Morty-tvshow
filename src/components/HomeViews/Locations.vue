...
<template>
  <div class="mx-10 overflow-y-hidden">
    <div
      class="mx-36 my-5 px-10 py-3 text-center bg-[#092E49] h-[95vh] rounded-lg border-[1px] border-orange-600 relative">
      ...
      <div v-else
        ...
        <div v-for="location in locations"
          ...
          <router-link
            ...
            <div
              class="bg-[#102141f1] border-[1px] border-green-600 rounded-full px-16 py-3 w-96 hover:bg-[#0E1C36] hover:border-orange-400 cursor-pointer text-center text-orange-400">
              {{ location.name }}
            </div>
          </router-link>
